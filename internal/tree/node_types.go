...
// Meta-repos (ending with -monorepo, -muno, -metarepo) are typically small
// and should be eagerly cloned to discover their children
func IsMetaRepo(repoName string) bool {
	suffixes := []string{"-monorepo", "-muno", "-metarepo"}
